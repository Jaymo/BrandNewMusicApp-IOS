...
- (UIView *)createContainerView
{
    ...
    //NSLog(@"dialogContainer frame %@",NSStringFromCGRect(dialogContainer.frame));
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    if ([buttonTitles count] == 1) {
        ...
        [closeButton setFrame:CGRectMake(0.0, container.bounds.size.height - buttonHeight, buttonWidth, buttonHeight)];
        //NSLog(@"Close button frame %f %f",closeButton.frame.size.width,closeButton.frame.size.height);
        
        [closeButton addTarget:self action:@selector(customIOS7dialogButtonTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
        [closeButton setTag:0];
        
        [closeButton setBackgroundImage:[UIImage imageNamed:@"cancel_btn_big_bg.png"] forState:UIControlStateNormal];
        ...
        [closeButton.titleLabel setFont:[UIFont fontWithName:@"GothamRounded-Light" size:20.0]];
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (i == 0) {
            [closeButton setBackgroundImage:[UIImage imageNamed:@"cancel_btn_bg.png"] forState:UIControlStateNormal];
            }else{
                [closeButton setBackgroundImage:[UIImage imageNamed:@"save_btn_bg.png"] forState:UIControlStateNormal];

            }
        [closeButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
        [closeButton.titleLabel setFont:[UIFont fontWithName:@"GothamRounded-Light" size:16.0]];
        [container addSubview:closeButton];
    }
}
